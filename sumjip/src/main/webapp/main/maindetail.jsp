				...
				<div class="room-item">
					...
					if (dto.getPpic1() == null) {
						...
						<a href="ProductContent.pr?pno=<%=dto.getPno()%>">
							<img src="upload/noimg.jpg" width="370px" height="240px"></a>
						<%
					} else {
						%>
						<a href="ProductContent.pr?pno=<%=dto.getPno()%>">
							<img src="upload/<%=dto.getPpic1()%>" width="370px" height="240px"></a>
						<%
					}
					%>
					<div class="ri-text">
			...
			<div class="col-lg-12">
				<div class="room-pagination">
					...
					if (endPage < pageCount) {
						%>
						<a href="Main.me?pageNum=<%=startPage + pageBlock%>">[10페이지 다음]<i class="fa fa-long-arrow-right"></i></a>
						<%
					}
					%>
				</div>
