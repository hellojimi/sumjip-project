...
<body>
		...
		<div class="menu-item">
			<div class="container">
				<div class="row">
					<div class="col-lg-2">
						<div class="logo">
							<a href="Main.me"> <img src="img/islandzip3.png" alt=""></a>
						</div>
					</div>
					<div class="col-lg-10">
						<div class="nav-menu">
	...
	<div class="productsearch-section">
		<h3 class="search_name">제주시 펜션</h3>
		<br>
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
				...
				<div class="col-lg-12">
					<div class="room-pagination">
						...
						if (startPage > pageBlock) {
							%>
							<a href="Region1.me?pageNum=<%=startPage - pageBlock%>">[10페이지 이전]<i class="fa fa-long-arrow-right"></i>
							</a>
							<%
						}
						...
						if (endPage < pageCount) {
							%>
							<a href="Region1.me?pageNum=<%=startPage + pageBlock%>">[10페이지 다음] <i class="fa fa-long-arrow-right"></i>
							</a>
							<%
						}
						%>
