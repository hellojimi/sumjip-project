				...
				<div class="col-lg-6">
					<div class="tn-right">
						...
						if (id != null) {
							...
							%>
							<div id="login">
								<a href="MemberLogin.me">Login</a> | <a href="MemberAgree.me">Join</a>
							</div>
							<%
						}
						%>
...
<div class="productsearch-section">
	<h3 class="search_name">마음에 드시나요 ?</h3>
	<br>
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
								...
								<div class="col-md-9">
									<div class="boking-table">
										<div class="row">
											...
											<div class="col-md-4">
												<br> <input type="submit" class="mainsearch_button" value="검색">
												</form>
											</div>
										</div>
									</div>
			...
			<div class="col-lg-12">
				<div class="room-pagination">
					...
					if (startPage > pageBlock) {
						%>
						<a href="Result.me?pageNum=<%=startPage - pageBlock%>&indate=<%=indate%>&outdate=<%=outdate%>&guest=<%=guest%>&region=<%=region%>">[10페이지 이전]<i class="fa fa-long-arrow-right"></i>
						</a>
						<%
					}
					...
					if (endPage < pageCount) {
						%>
						<a href="Result.me?pageNum=<%=startPage + pageBlock%>&indate=<%=indate%>&outdate=<%=outdate%>&guest=<%=guest%>&region=<%=region%>">[10페이지 다음] <i class="fa fa-long-arrow-right"></i>
						</a>
						<%
					}
					%>
