	...
	<article>
		<div class="container">
			...
			<table class="table table">
				...
				<tr>
					<td class="tt">글쓴날짜</td>
					<td class="tt2"><%=qdto.getQadate()%></td>
				</tr>
				<tr class="co">
					<td class="tt">글내용</td>
					<td class="tt2"><%=qdto.getAnswer()%></td>
				</tr>
			</table>
			<div id="table_search">
				<button type="button" class="btn btn-outline-success" value="글목록" onclick="location.href='QnaList.qa'">글목록</button>
				<br>
			</div>
		</div>
	</article>
