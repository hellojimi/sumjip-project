				...
				<div class="container">
					...
					<table class="table table-hover">
						<tbody>
							...
							<tr>
								<td><input type="text" name="qtitle" class="form-control" maxlength="40" placeholder="제목을 작성하세요"></td>
							</tr>
							<tr>
								<td><textarea name="qcontent" class="form-control" maxlength="1024" style="height: 400px;" placeholder="글 내용을 작성하세요"></textarea></td>
							</tr>
						</tbody>
					</table>
					<div id="table_search">
						<button type="submit" value="글쓰기" class="btn btn-outline-success">글쓰기</button>
						<br>
					</div>
				</div>
			</form>
